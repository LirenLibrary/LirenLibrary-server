...
public class DonationTest {
    ...
    public void donation_status_is_new_by_default() throws Exception {
        Donation donation = donation(deviceId("123"), newArrayList(newBook("isbn1234")));
    ...
    public void book_status_changed_to_approved_when_approve_a_new_book() throws Exception {
        Donation donation = donation(deviceId("12345"), newArrayList(newBook("isbn1234")));
        donation.approve("isbn1234");
        assertThat(donation.books(), not(hasItem(newBook(("isbn1234")))));
        assertThat(donation.books(), hasItem(approvedBook("isbn1234")));
    }
    ...
    public void book_status_changed_to_rejected_when_reject_a_new_book() throws Exception {
        ...
        assertThat(donation.books(), not(hasItem(newBook("isbn1234"))));
        assertThat(donation.books(), hasItem(rejectedBook("isbn1234")));
    }

    @Test
    public void book_status_changed_to_rejected_when_reject_a_approved_book() throws Exception {
        Donation donation = donation(deviceId("12345"), newArrayList(approvedBook("isbn1234")));
        donation.reject("isbn1234");
        assertThat(donation.books(), not(hasItem(approvedBook("isbn1234"))));
        assertThat(donation.books(), hasItem(rejectedBook("isbn1234")));
    }

    @Test
    public void book_status_changed_to_approved_when_approve_a_rejected_book() throws Exception {
        Donation donation = donation(deviceId("12345"), newArrayList(rejectedBook("isbn1234")));
        donation.approve("isbn1234");
        assertThat(donation.books(), not(hasItem(rejectedBook("isbn1234"))));
        assertThat(donation.books(), hasItem(approvedBook("isbn1234")));
    }
}
